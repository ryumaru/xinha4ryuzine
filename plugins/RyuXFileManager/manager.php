<?php
/**
 * The main GUI for the RyuXFileManager.
...
<input type="hidden" name="__plugin" value="RyuXFileManager" />
...
<table id="imgManager_table" border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
...
<tr class="xinha_mobile"><td style="padding:10px; padding-top:0px;" class="xinha_mobile">
	<div id="messages"><span id="message">Loading</span><img src="<?php print $IMConfig['base_url'];?>img/dots.gif" width="22" height="12" alt="..." /></div>
	<iframe src="about:blank" name="imgManager" id="imgManager" class="imageFrame" scrolling="auto" title="Image Selection" frameborder="0" height="155"></iframe>
</td></tr>
</table>
</fieldset>
<!-- image properties -->
<div id="controls">
	<table class="inputTable">
		<tr>
            ...
            <div style="padding:4px;background-color:#CCC;border:1px inset;width: 150px; height: 100px;overflow:hidden;">
...
<!--// image properties -->	
	<div style="text-align: right;"> 
          ...
          <button type="button" class="buttons" onclick="closeFileManager();return onOK();">OK</button>
          <button type="button" class="buttons" onclick="closeFileManager();return onCancel();">Cancel</button>
    </div>
</div>
</form>
<script type="text/javascript">
	if ( window.parent.parent.RYU.device.Platform=="iOS" && window.parent.parent.RYU.device.v > 4) {
		document.getElementById('imgManager_table').className = "xinha_mobile";
	}
	function closeFileManager() {
		window.parent.parent.RYU.toggleDialog('file_manager');
		window.parent.parent.document.getElementById('fileManager').src = '';
	}
</script>
</body>
</html>
