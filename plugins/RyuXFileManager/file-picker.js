/**
 * An input field File Picker utilising the Xinha RyuXFileManager.
 *
 * Hijack the Xinha RyuXFileManager plugin to provide a file URL picker
 ...
 * except it opens the familiar RyuXFileManager dialog to upload/select
 ...
 *         // See RyuXFileManager for more configuration options !           
 *       );
...
FilePicker.prototype.backend             = _editor_url + 'plugins/RyuXFileManager/backend.php?__plugin=RyuXFileManager&';
...
FilePicker.prototype.backend_config_secret_key_location = 'Xinha:RyuXFileManager';
//---------------------------------------------------------
