<?php
/**
 * RyuXFileManager, list images, directories, and thumbnails.
...
/**
 * RyuXFileManager Class.
 * @author Wei Zhuo, Afru, Krzysztof Kotowicz, Raimund Meyer
 * @version $Id: RyuXFileManager.php 1171 2009-03-19 22:06:09Z ray $
 */
class RyuXFileManager 
{
	/**
	 * Configuration array.
	 */
	 ...
	 */
	function RyuXFileManager($config, $mode = null)
	{
		$this->config = $config;
	...
	function getThumbName($fullpathfile) 
	{
		...
		else
		{
			...
			{
				//error_log('RyuXFileManager: Error in creating thumbnail name');
			}
		}
	}
	...
	function getThumbURL($relative) 
	{
		...
		else
		{
			...
			{
				//error_log('RyuXFileManager: Error in creating thumbnail url');
			}
